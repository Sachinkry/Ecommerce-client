...
export default function ProductCard2() {
    ...
    return (
        <div className="flex-1 w-full max-w-sm  hover:shadow-md hover:shadow-neutral-700 hover:rounded-lg hover:cursor-pointer rouned-lg" onClick={() => handleCardClick()}>
            <div className=" aspect-square bg-neutral-900 rounded-lg shadow ">
                <div className="bg-neutral-200 rounded-t-lg">
                    <img className="rounded-t-lg w-full" src='/watchhd.jpg' />
                </div>
